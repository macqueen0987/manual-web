...
제품 매뉴얼 웹 앱 (상세: [spec.md](spec.md)).

## 멀티 에이전트 (Agent Gate)

여러 AI(Cursor/Kimi)가 동시에 작업할 때 파일 충돌·빌드 게이트를 조율합니다.
...
훅 재설치: `powershell -File path\to\agent-gate\scripts\install-agent-gate-hooks.ps1 -Target both`
